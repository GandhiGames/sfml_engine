...
void EntityManager::Draw(){
    sf::RenderWindow* wnd = m_context->GetWindow()->GetRenderWindow();
...
//TODO: look into binary space partitioning
...
void EntityManager::LoadEnemyTypes(const std::string& l_name){
    std::ifstream file;
    file.open(resourcePath() + std::string("media/Characters/") + l_name);
